...
class Bankswitch
{
  public:
    ...
    {
      if(BSPF::equalsIgnoreCase(name, "2K") ||
         BSPF::equalsIgnoreCase(name, "4K"))           return BS_4K;
      else if(BSPF::equalsIgnoreCase(name, "084") ||
              BSPF::equalsIgnoreCase(name, "0840"))    return BS_0840;
      else if(BSPF::equalsIgnoreCase(name, "2IN1"))    return BS_2IN1;
      else if(BSPF::equalsIgnoreCase(name, "4IN1"))    return BS_4IN1;
      else if(BSPF::equalsIgnoreCase(name, "8IN1"))    return BS_8IN1;
      else if(BSPF::equalsIgnoreCase(name, "16IN1"))   return BS_16IN1;
      else if(BSPF::equalsIgnoreCase(name, "32IN1"))   return BS_32IN1;
      ...
      else if(BSPF::equalsIgnoreCase(name, "CTY"))     return BS_CTY;
      ...
      else if(BSPF::equalsIgnoreCase(name, "F4S") ||
              BSPF::equalsIgnoreCase(name, "F4SC"))    return BS_F4SC;
      else if(BSPF::equalsIgnoreCase(name, "F6"))      return BS_F6;
      else if(BSPF::equalsIgnoreCase(name, "F6S") ||
              BSPF::equalsIgnoreCase(name, "F6SC"))    return BS_F6SC;
      else if(BSPF::equalsIgnoreCase(name, "F8"))      return BS_F8;
      else if(BSPF::equalsIgnoreCase(name, "F8S") ||
              BSPF::equalsIgnoreCase(name, "F8SC"))    return BS_F8SC;
      else if(BSPF::equalsIgnoreCase(name, "FA"))      return BS_FA;
      else if(BSPF::equalsIgnoreCase(name, "FA2"))     return BS_FA2;
      ...
      else if(BSPF::equalsIgnoreCase(name, "CU") ||
              BSPF::equalsIgnoreCase(name, "CUSTOM"))  return BS_CUSTOM;
      else                                             return BS_AUTO;
    }
};
